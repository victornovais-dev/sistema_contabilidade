...
public final class SecurityPaths {
  ...
  public static final String MANAGE_INTERNS_PAGE = "/gerenciar_estagiarios";
  public static final String MANAGE_INTERNS_PAGE_HTML = MANAGE_INTERNS_PAGE + HTML_SUFFIX;
